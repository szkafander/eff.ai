...
const menuContent = {
	...
	'energy-use': {
		...
		content: `
			...
			<p>The International Energy Agency projects that data center electricity consumption, driven largely by AI workloads, could more than double by 2026, reaching over 1,000 TWh annually — roughly the total electricity consumption of Japan. A single query to a frontier LLM like GPT-4 is estimated to consume 5–10 Wh of energy, roughly ten times that of a traditional web search. Multiplied across billions of daily queries, the numbers become enormous.</p>
